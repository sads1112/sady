/*
 * Copyright (C) (R) 2016 The Dagger Authors.
 *
...
private final class Compilers {
  ...
  private static Compiler compilerWithOptions(CompilerMode... compilerModes) {
  ...
  private static Compiler compilerWithOptions(Iterable<String> options) {
